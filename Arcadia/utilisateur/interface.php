...
if (isset($_SESSION['permissions'])) {
    ...
    $pages = [
        '../utilisateur/inscription.php' => 'create_account',
        '../utilisateur/form_animal.php' => 'modify_animals',
        '../utilisateur/form_habitat.php' => 'modify_habitat',
        '../utilisateur/form_service.php' => 'modify_service',
        '../utilisateur/form_rapport.php' => 'view_rapport',
        '../utilisateur/dashboard.php' => 'view_dashboard',
        '../utilisateur/feeding_form.php' => 'feeding_animal',
        '../utilisateur/rapport_staff.php' => 'vet_feeding',
        '../utilisateur/validate_avis.php' => 'reviews_client',
        '../utilisateur/rapport_staff.php' => 'vet_feeding',
        '../utilisateur/rapport_veterinaire.php' => 'admin_rapport',
        
    ];
} else {
    // Si l'utilisateur n'est pas authentifié ou n'a pas de permissions définies, redirigez-le vers la page de connexion
    header('Location: ../arcadia/public/account_page.php');
    exit();
}
?>
